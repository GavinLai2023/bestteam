...
Deleting a skill/KB scans deployed workflows for references, then deletes; a
concurrent deploy that adds a reference in that window would leave a deployed
workflow pointing at a just-deleted resource (review finding 3 -- FastAPI runs
...
Either way no orphaned deployed workflow results. This is an interim mitigation;
